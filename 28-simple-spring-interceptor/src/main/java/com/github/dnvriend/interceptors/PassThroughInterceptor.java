...
public class PassThroughInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        System.out
            .println("pre handle: " + handler.getClass() + " -> " + getHandlerMethod(handler));
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        System.out
            .println("post handle: " + handler.getClass() + " -> " + getHandlerMethod(handler));
        HandlerMethod method = getHandlerMethod(handler);
        if (method != null) {
            System.out.println(method.getMethod().getName());
        }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response,
        ...
        System.out.println(
            "after completion: " + handler.getClass() + " -> " + getHandlerMethod(handler));
        HandlerMethod method = getHandlerMethod(handler);
        if (method != null) {
            System.out.println(method.getMethod().getName());
        }
