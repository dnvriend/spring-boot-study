...
public class TripleService {
    ...
    public Triple saveTripleWithInterval(String k1, String k2, String k3, LocalDateTime start,
        LocalDateTime end, String value) {
    ...
    public Optional<Triple> findOne(String k1, String k2, String k3, LocalDateTime start,
        LocalDateTime end) {
